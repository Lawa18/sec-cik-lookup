...
# 🔹 STEP 2: EXTRACT FINANCIAL DATA FROM XBRL
def extract_summary(xbrl_url):
    ...
    # ✅ **Stable Key Mappings**
    key_mappings = {
        "Revenue": ["Revenues", "SalesRevenueNet", "Revenue"],
        ...
        "CashPosition": ["CashAndCashEquivalents", "ShortTermInvestments"],
    ...
    current_liabilities_values = root.xpath("//*[local-name()='LiabilitiesCurrent']/text()", namespaces=namespaces)
